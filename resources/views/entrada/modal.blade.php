	...
	<div class="card-body">
		<div class="row">
					...
					<div class="form-group">
						<label for="serie_comprobante">Razon Social</label>
						<input type="text" readonly class="form-control" placeholder="orden de compra" value="{{ $entradas->razon_social}}">
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
						<label for="fecha">Fecha</label>
						<input type="text" readonly class="form-control" placeholder="orden de compra" value="{{ $entradas->fecha}}">
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
						<label for="orden">Orden</label>
						<input type="text" readonly class="form-control" placeholder="orden de compra" value="{{ $entradas->orden_compra}}">
					</div>
				</div>
					<div class="col-md-4">
					<div class="form-group">
						<label for="serie_comprobante">Nº factura</label>
						<input type="text" readonly class="form-control" placeholder="orden de compra" value="{{ $entradas->num_proforma}}">
					</div>
				</div>
				@endforeach
							 ...
							 <tr>
							   ...
							   <td class="text-center">{{$datas->cantidad_ingresos}}</td>
							   <td class="text-center">{{number_format($datas->precio_ingresos, 2, ',', '.')}}</td>
