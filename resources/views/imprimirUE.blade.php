    ...
    <table  border="1" width="100%" cellspacing=2 cellpadding=2 style="font-size: 8px;">
        <thead>
            ...
            <tr>
                ...
                <th style="text-align:left;" width="80%"><strong>{{ $data[0]->ue }} </strong></th>
            </tr>
            <tr>
                ...
                <th style="text-align:left;" width="80%"><strong> {{ $data[0]->distrito}} </strong></th>
            </tr>
    ...
    <table id="tabla-rebelde" border="1" width="100%" cellspacing=2 cellpadding=2 style="font-size: 8px;">
        ...
        @endphp
            ...
            <tr>
                ...
                <td class="text-center">{{ $datas->fecha }}</td>
